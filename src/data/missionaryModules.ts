...
export const MISSIONARY_MODULES: MissionaryModule[] = [
  ...
  },
  {
    ...
    color: MISSIONARY_COLOR,
    vocab: [
      { en: 'sacrament', es: 'el sacramento', sw: 'sakramenti', pt: 'o sacramento' },
      { en: 'confirmation', es: 'la confirmación', sw: 'uthibitisho', pt: 'a confirmação' },
      { en: 'priesthood blessing', es: 'la bendición del sacerdocio', sw: 'baraka ya ukuhani', pt: 'a bênção do sacerdócio' },
      { en: 'calling', es: 'el llamamiento', sw: 'wito wa kanisa', pt: 'o chamado da Igreja' },
      { en: 'conduct a meeting', es: 'presidir una reunión', sw: 'kuongoza mkutano', pt: 'presidir uma reunião' },
      { en: 'opening prayer', es: 'la oración de apertura', sw: 'maombi ya ufunguzi', pt: 'a oração de abertura' },
      { en: 'closing prayer', es: 'la oración de cierre', sw: 'maombi ya kufunga', pt: 'a oração de encerramento' },
      { en: 'Sacrament Meeting', es: 'la Reunión Sacramental', sw: 'Mkutano wa Sakramenti', pt: 'a Reunião Sacramental' },
      { en: 'ride to church', es: 'el aventón a la iglesia', sw: 'lifti kwenda kanisani', pt: 'a carona para a igreja' },
      { en: 'assignment', es: 'la asignación', sw: 'kazi ya kanisa', pt: 'a designação' },
    ],
    samplePhrase: {
