...
const APP_URL_LANG = `${MISSIONARY_APP_URL}&lang=de`
...
export default function MissionaryGerman() {
  usePageMeta({ title: 'Missionary German — Missionarsdeutsch', lang: 'de', canonical: 'https://languagethreshold.com/missionary-german' })
  return (
    <div>
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <FadeIn>
            <div className="flex items-center gap-2 mb-6">
              <span className="text-xs uppercase tracking-[0.25em] font-semibold" style={{ ...sansFont, color: LANG_COLOR }}>Missionarsdeutsch</span>
            ...
            <h1 className="leading-[1.1] mb-6" style={{ ...displayFont, fontSize: 'clamp(2.8rem, 6vw, 5.5rem)', color: '#F7F3EC' }}>
              Ihr Missionsfeld<br />
              <em style={{ color: LANG_COLOR }}>spricht Deutsch.</em>
            </h1>
            <p className="max-w-2xl text-lg leading-relaxed mb-4" style={{ ...sansFont, color: '#A89F94', fontSize: 'clamp(1rem, 2vw, 1.2rem)' }}>
              Neun KI-gestützte Module zu Wiederherstellung, Heilsplan, Missionierung, Taufverpflichtung und Missionarsalltag — die spezifische Sprache der HLT-Missionsarbeit in deutschsprachigen Gebieten.
            </p>
            <p className="max-w-xl text-base leading-relaxed mb-10 italic" style={{ ...serifFont, color: '#A89F94' }}>
              "Mein Vater und ich gingen auf eine Dienstmission. Wir arbeiteten mit Menschen zusammen, die alles hatten, was wir brauchten — außer einer gemeinsamen Sprache. Die Evangeliumsbotschaft verdient mehr als eine Sprachbarriere." — Toby Anderton, MD
            </p>
        ...
        <section className="py-20" style={{ backgroundColor: '#111111' }}>
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { stat: '130M+', label: 'deutschsprachige Menschen weltweit — von Deutschland bis Österreich, der Schweiz und Namibia', source: 'Auswärtiges Amt' },
                { stat: '10+', label: 'aktive HLT-Missionen in deutschsprachigen Ländern und Nachbarregionen', source: 'Die Kirche Jesu Christi der Heiligen der Letzten Tage' },
                { stat: 'Wochen', label: 'nicht Jahre — die Zeit bis zur Gesprächsflüssigkeit in Evangeliumsdiskussionen', source: 'Language-Threshold-Methode' },
              ].map(item => (
      ...
      <FadeIn>
        <section className="py-20">
          <div className="max-w-6xl mx-auto px-6">
            <div className="mb-4">
              <span className="text-xs uppercase tracking-[0.25em] font-semibold" style={{ ...sansFont, color: LANG_COLOR }}>Missions-kritische Phrasen</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold mb-10" style={{ ...displayFont, color: '#F7F3EC' }}>
              Neun Sätze, die jeder Missionar braucht.
            </h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div key={0} className="rounded-xl p-4" style={{ backgroundColor: '#161616', border: '1px solid rgba(239,68,68,0.12)' }}>
                  <p className="text-sm font-semibold mb-1" style={{ ...sansFont, color: LANG_COLOR }}>Wir sind Missionare der Kirche Jesu Christi.</p>
                  <p className="text-xs" style={{ ...sansFont, color: '#A89F94' }}>We are missionaries of The Church of Jesus Christ.</p>
                </div>
                <div key={1} className="rounded-xl p-4" style={{ backgroundColor: '#161616', border: '1px solid rgba(239,68,68,0.12)' }}>
                  <p className="text-sm font-semibold mb-1" style={{ ...sansFont, color: LANG_COLOR }}>Dürfen wir eine Botschaft mit Ihnen teilen?</p>
                  <p className="text-xs" style={{ ...sansFont, color: '#A89F94' }}>Can we share a message with you?</p>
                </div>
                <div key={2} className="rounded-xl p-4" style={{ backgroundColor: '#161616', border: '1px solid rgba(239,68,68,0.12)' }}>
                  <p className="text-sm font-semibold mb-1" style={{ ...sansFont, color: LANG_COLOR }}>Gott liebt Sie und hat einen Plan für Sie.</p>
                  <p className="text-xs" style={{ ...sansFont, color: '#A89F94' }}>God loves you and has a plan for you.</p>
                </div>
                <div key={3} className="rounded-xl p-4" style={{ backgroundColor: '#161616', border: '1px solid rgba(239,68,68,0.12)' }}>
                  <p className="text-sm font-semibold mb-1" style={{ ...sansFont, color: LANG_COLOR }}>Haben Sie schon im Buch Mormon gelesen?</p>
                  <p className="text-xs" style={{ ...sansFont, color: '#A89F94' }}>Have you read from the Book of Mormon?</p>
                </div>
                <div key={4} className="rounded-xl p-4" style={{ backgroundColor: '#161616', border: '1px solid rgba(239,68,68,0.12)' }}>
                  <p className="text-sm font-semibold mb-1" style={{ ...sansFont, color: LANG_COLOR }}>Wir laden Sie ein zu beten, um zu wissen, ob es wahr ist.</p>
                  <p className="text-xs" style={{ ...sansFont, color: '#A89F94' }}>We invite you to pray to know if it is true.</p>
                </div>
                <div key={5} className="rounded-xl p-4" style={{ backgroundColor: '#161616', border: '1px solid rgba(239,68,68,0.12)' }}>
                  <p className="text-sm font-semibold mb-1" style={{ ...sansFont, color: LANG_COLOR }}>Wann können wir zurückkommen, um fortzufahren?</p>
                  <p className="text-xs" style={{ ...sansFont, color: '#A89F94' }}>When can we come back to continue?</p>
                </div>
                <div key={6} className="rounded-xl p-4" style={{ backgroundColor: '#161616', border: '1px solid rgba(239,68,68,0.12)' }}>
                  <p className="text-sm font-semibold mb-1" style={{ ...sansFont, color: LANG_COLOR }}>Möchten Sie mit uns in die Kirche kommen?</p>
                  <p className="text-xs" style={{ ...sansFont, color: '#A89F94' }}>Would you like to come to church with us?</p>
                </div>
                <div key={7} className="rounded-xl p-4" style={{ backgroundColor: '#161616', border: '1px solid rgba(239,68,68,0.12)' }}>
                  <p className="text-sm font-semibold mb-1" style={{ ...sansFont, color: LANG_COLOR }}>Haben Sie schon an die Taufe gedacht?</p>
                  <p className="text-xs" style={{ ...sansFont, color: '#A89F94' }}>Have you thought about baptism?</p>
                </div>
                <div key={8} className="rounded-xl p-4" style={{ backgroundColor: '#161616', border: '1px solid rgba(239,68,68,0.12)' }}>
                  <p className="text-sm font-semibold mb-1" style={{ ...sansFont, color: LANG_COLOR }}>Haben Sie Fragen zu dem, was wir lehren?</p>
      ...
      <section id="modules" className="py-28" style={{ backgroundColor: '#111111' }}>
        <div className="max-w-6xl mx-auto px-6">
          <FadeIn>
            <div className="mb-4">
              <span className="text-xs uppercase tracking-[0.25em] font-semibold" style={{ ...sansFont, color: LANG_COLOR }}>Neun Missionsmodule</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold mb-4" style={{ ...displayFont, color: '#F7F3EC' }}>
              Von der ersten Tür<br />
              <em style={{ color: '#C9A84C' }}>bis zum Taufbecken.</em>
            </h2>
            <p className="max-w-2xl text-base leading-relaxed mb-16" style={{ ...sansFont, color: '#A89F94' }}>
              Jedes Modul zielt auf einen bestimmten Moment im Missionszyklus ab — finden, lehren, verpflichten und halten. KI-Übungspartner simulieren echte Evangeliumsgespräche.
            </p>
          </FadeIn>
        ...
        <section className="py-20">
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            <h2 className="text-3xl font-bold mb-4" style={{ ...displayFont, color: '#F7F3EC' }}>
              Die Evangeliumsbotschaft verdient<br />
              <em style={{ color: LANG_COLOR }}>mehr als eine Sprachbarriere.</em>
            </h2>
            <p className="text-base leading-relaxed mb-4" style={{ ...sansFont, color: '#A89F94' }}>
              "Werden Sie dem Beispiel Jesu Christi folgen und sich taufen lassen?" ist nicht nur ein Satz. Es ist die Einladung, die Leben verändert.
            </p>
            <p className="text-sm" style={{ ...serifFont, color: '#A89F94' }}>
              Die KI-Übungspartner von Language Threshold simulieren echte Evangeliumsdiskussionen, damit Missionare im Feld bereit ankommen.
            </p>
          </div>
        </section>
      </FadeIn>
        ...
        <section className="py-20" style={{ backgroundColor: '#111111' }}>
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              ...
              >
                <div className="text-2xl mb-2">🏥</div>
                <div className="text-lg font-bold mb-1" style={{ ...displayFont, color: '#F7F3EC' }}>Medical German</div>
                <p className="text-sm" style={{ ...sansFont, color: '#A89F94' }}>Thirteen clinical modules for German-speaking patients.</p>
              </a>
              <a
      ...
      <FadeIn>
        <section className="py-28 text-center">
          <div className="max-w-2xl mx-auto px-6">
            <span className="text-xs uppercase tracking-[0.25em] font-semibold" style={{ ...sansFont, color: LANG_COLOR }}>Ihr Missionsfeld wartet</span>
            <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6" style={{ ...displayFont, color: '#F7F3EC' }}>
              Ihre Untersuchenden sprechen Deutsch.<br />
              <em style={{ color: LANG_COLOR }}>Jetzt auch Sie.</em>
            </h2>
            ...
            <p className="text-xs" style={{ ...sansFont, color: '#A89F94' }}>Keine Anmeldung. Keine Kreditkarte.</p>
          </div>
        </section>
      </FadeIn>
    </div>
