...
const CONTRACTOR_APP_URL = `${APP_URL}?module=framer&lang=it`
...
export default function ContractorItalian() {
  usePageMeta({ title: 'Construction Italian — Vocabolario del Cantiere', lang: 'it', canonical: 'https://languagethreshold.com/contractor-italian' })
  return (
    <div>
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <FadeIn>
            <div className="flex items-center gap-2 mb-6">
              <span className="text-xs uppercase tracking-[0.25em] font-semibold" style={{ ...sansFont, color: LANG_COLOR }}>Italiano del Cantiere</span>
            ...
            <h1 className="leading-[1.1] mb-6" style={{ ...displayFont, fontSize: 'clamp(2.8rem, 6vw, 5.5rem)', color: '#F7F3EC' }}>
              L'italiano che la tua squadra<br />
              <em style={{ color: LANG_COLOR }}>parla in cantiere.</em>
            </h1>
            <p className="max-w-2xl text-lg leading-relaxed mb-4" style={{ ...sansFont, color: '#A89F94', fontSize: 'clamp(1rem, 2vw, 1.2rem)' }}>
              Carpentieri, capomastri, idraulici, elettricisti — nove moduli di vocabolario professionale
              per i team edili italofoni. Le parole di cui hai bisogno in cantiere, non in aula.
            </p>
            <p className="max-w-xl text-base leading-relaxed mb-10 italic" style={{ ...serifFont, color: '#A89F94' }}>
              "In un cantiere, una comunicazione sbagliata costa tempo, denaro e può costare vite.
              La lingua è lo strumento più importante che puoi acquisire."
            </p>
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                { stat: '9', label: 'moduli specializzati che coprono tutta la catena edile — dalle fondamenta alle rifiniture', source: 'Language Threshold' },
                { stat: 'Settimane', label: 'per raggiungere la comunicazione funzionale in cantiere — non anni di corsi', source: 'Metodo Language Threshold' },
              ].map(item => (
      ...
      <section id="modules" className="py-28">
        <div className="max-w-6xl mx-auto px-6">
          <FadeIn>
            <div className="mb-4">
              <span className="text-xs uppercase tracking-[0.25em] font-semibold" style={{ ...sansFont, color: LANG_COLOR }}>Nove moduli per mestiere</span>
            </div>
            ...
            <p className="max-w-2xl text-base leading-relaxed mb-16" style={{ ...sansFont, color: '#A89F94' }}>
              ...
              una sessione di pratica con l'IA. Vero vocabolario di cantiere, non da manuale scolastico.
            </p>
          </FadeIn>
      ...
      <FadeIn>
        <section className="py-28 text-center relative overflow-hidden" style={{ backgroundColor: '#111111' }}>
          <div className="max-w-2xl mx-auto px-6 relative">
            <span className="text-xs uppercase tracking-[0.25em] font-semibold" style={{ ...sansFont, color: LANG_COLOR }}>Il cantiere ti aspetta</span>
            <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6" style={{ ...displayFont, color: '#F7F3EC' }}>
              La tua squadra parla italiano.<br />
            ...
            <p className="text-xs" style={{ ...sansFont, color: '#A89F94' }}>Senza registrazione. Senza carta di credito. Scegli il tuo mestiere e inizia.</p>
          </div>
        </section>
      </FadeIn>
    </div>
