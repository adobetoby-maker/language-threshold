...
const CLIMBING_APP_URL = `${APP_URL}?module=gear&lang=it`
...
export default function ClimbingItalian() {
  usePageMeta({ title: 'Climbing Italian — Vocabolario dell\'Arrampicata', lang: 'it', canonical: 'https://languagethreshold.com/climbing-italian' })
  return (
    <div>
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <FadeIn>
            <div className="flex items-center gap-2 mb-6">
              <span className="text-xs uppercase tracking-[0.25em] font-semibold" style={{ ...sansFont, color: LANG_COLOR }}>Italiano dell'Arrampicata</span>
            ...
            <h1 className="leading-[1.1] mb-6" style={{ ...displayFont, fontSize: 'clamp(2.8rem, 6vw, 5.5rem)', color: '#F7F3EC' }}>
              L'italiano che gli arrampicatori<br />
              <em style={{ color: LANG_COLOR }}>parlano sulla parete.</em>
            </h1>
            <p className="max-w-2xl text-lg leading-relaxed mb-4" style={{ ...sansFont, color: '#A89F94', fontSize: 'clamp(1rem, 2vw, 1.2rem)' }}>
              Attrezzatura, comandi, vie, boulder, sicurezza — dieci moduli di vocabolario professionale
              per gli arrampicatori italofoni. Le parole di cui hai bisogno in falesia, non in aula.
            </p>
            <p className="max-w-xl text-base leading-relaxed mb-10 italic" style={{ ...serifFont, color: '#A89F94' }}>
              "L'arrampicata è un dialogo silenzioso tra il climber e la roccia.
              Con il vocabolario giusto, questo dialogo si apre a tutti."
            </p>
      ...
      <FadeIn>
        <section className="py-20" style={{ backgroundColor: '#111111' }}>
          <div className="max-w-6xl mx-auto px-6">
            <div className="mb-8">
              <span className="text-xs uppercase tracking-[0.25em] font-semibold" style={{ ...sansFont, color: LANG_COLOR }}>Attrezzatura essenziale</span>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
              {GEAR_PHOTOS.map(g => (
                <div key={g.name} className="text-center">
                  <div className="rounded-xl overflow-hidden mb-2 aspect-square" style={{ backgroundColor: '#1a1a1a' }}>
                    <img src={g.photo} alt={g.it} className="w-full h-full object-cover opacity-80" />
                  </div>
                  <p className="text-xs font-semibold" style={{ ...sansFont, color: '#F7F3EC' }}>{g.it}</p>
      ...
      <section id="modules" className="py-28">
        <div className="max-w-6xl mx-auto px-6">
          <FadeIn>
            <div className="mb-4">
              <span className="text-xs uppercase tracking-[0.25em] font-semibold" style={{ ...sansFont, color: LANG_COLOR }}>Dieci moduli di arrampicata</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold mb-4" style={{ ...displayFont, color: '#F7F3EC' }}>
              Ogni disciplina.<br />
              <em style={{ color: '#C9A84C' }}>Il suo vocabolario.</em>
            </h2>
            <p className="max-w-2xl text-base leading-relaxed mb-16" style={{ ...sansFont, color: '#A89F94' }}>
              Clicca su un modulo per vedere il vocabolario, leggere frasi d'esempio e avviare
              una sessione di pratica con l'IA. Vero vocabolario di arrampicata, non da manuale scolastico.
            </p>
          </FadeIn>
      ...
      <FadeIn>
        <section className="py-28 text-center relative overflow-hidden" style={{ backgroundColor: '#111111' }}>
          <div className="max-w-2xl mx-auto px-6 relative">
            <span className="text-xs uppercase tracking-[0.25em] font-semibold" style={{ ...sansFont, color: LANG_COLOR }}>La parete ti aspetta</span>
            <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6" style={{ ...displayFont, color: '#F7F3EC' }}>
              Il tuo team arrampica in italiano.<br />
              <em style={{ color: LANG_COLOR }}>Anche tu, adesso.</em>
            </h2>
            ...
            <p className="text-xs" style={{ ...sansFont, color: '#A89F94' }}>Senza registrazione. Senza carta di credito. Scegli la tua disciplina e inizia.</p>
          </div>
        </section>
      </FadeIn>
    </div>
